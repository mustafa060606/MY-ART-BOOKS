...
import com.mustafa.artbook.databinding.ActivityDetailsBinding;
...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (info.equals("new")){
            ...
            binding.imageView.setImageResource(R.drawable.mmm);
        }else {
    ...
    public Bitmap makeSmallerImage(Bitmap image,int maximumSize ){
        ...
        return image.createScaledBitmap(image,witdh,height,true);
    }
    public void selectimage(View view){
        if(ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,Manifest.permission.READ_EXTERNAL_STORAGE)){
                Snackbar.make(view,"Permissions needed for gallery",Snackbar.LENGTH_INDEFINITE).setAction("Give Permission", new View.OnClickListener() {
                    @Override
